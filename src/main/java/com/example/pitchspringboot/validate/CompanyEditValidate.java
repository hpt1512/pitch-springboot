...
@Component
public class CompanyEditValidate implements Validator {
    @Autowired
    ...
    public void validate(Object target, Errors errors) {
        ...
        Company oldCompany = companyService.findById(company.getId());

        if (company.getUser().getId() != oldCompany.getUser().getId()) {
